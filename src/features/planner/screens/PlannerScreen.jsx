...
import { usePlannerStore } from '../../../shared/store/plannerStore';
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <View style={styles.card}>
                <Text style={styles.cardTitle}>Buscador de Rutas Interactivo</Text>
                <Text style={styles.cardSubtitle}>Escribe a dónde vas o elige en el mapa. Nuestro algoritmo conectará las estaciones reales que existen en la ciudad y calculará tu mejor opción.</Text>
                ...
                <View style={styles.toggleRow}>
                    ...
                    >
                        <Text style={[styles.toggleText, clickMode === "ORIGIN" && styles.toggleTextActive]}>1. Fijar en Mapa (Origen)</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={[styles.toggleBtn, clickMode === "DESTINATION" && styles.toggleBtnActiveDest]}
                        onPress={() => setClickMode("DESTINATION")}
                    >
                        <Text style={[styles.toggleText, clickMode === "DESTINATION" && styles.toggleTextActive]}>2. Fijar en Mapa (Destino)</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.mapContainer}>
                    <MapView
                        ...
                        // Optimizaciones para teléfonos de gama baja
